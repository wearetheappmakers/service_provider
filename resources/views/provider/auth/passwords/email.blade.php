...
<div class="">
    ...
    @endif
    <form class="kt-form" method="POST" action="{{ url('/provider/password/email') }}">
        {{ csrf_field() }}
        ...
        <button class="btn btn-light btn-elevate kt-login__btn-secondary"><a href="{{url('provider/login')}}">Cancel</a></button>
        </div>
    </form>
</div>
@endsection
