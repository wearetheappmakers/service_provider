            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <form class="kt-form kt-form--label-right add_form" method="post" action="{{$url}}">
                        ...
                        if(isset($type)){
                            $index= route('provider.'.$resourcePath.'.index',array('type'=>$type));
                            $store=route('provider.'.$resourcePath.'.store',array('type'=>$type));
                        }else {
                            $index= route('provider.'.$resourcePath.'.index');
                            $store=route('provider.'.$resourcePath.'.store');
                        }
                        // echo $index;
                        // exit;
                        @endphp
                        @include('providerseller.'.$resourcePath.'.create')
