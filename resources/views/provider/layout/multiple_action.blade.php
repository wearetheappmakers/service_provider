...
<input type="hidden" name="status_url" id="status_url" value="{{ route('provider.home.change-multiple-status') }}" />
<input type="hidden" name="delete_url" id="delete_url" value="{{ route('provider.home.delete-multiple') }}" />
<input type="hidden" name="discount_url" id="discount_url" value="{{ route('provider.home.discount-multiple') }}" />
@if(isset($folder_name))
<input type="hidden" name="folder_name" id="folder_name" value="{{ $folder_name }}" />
@endif

<input type="hidden" name="orderby_url" id="orderby_url" value="{{ route('provider.home.change-order') }}" />
...
<script type="text/javascript">
    ...
    function ChangeMultiple(ids, field, params) {
        ...
        $.ajax({
            ...
            url: "{{route('provider.home.change-multiple-status')}}",
