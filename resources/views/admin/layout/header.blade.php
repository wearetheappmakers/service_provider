	...
	<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed noprint">
		...
		<div class="kt-header-mobile__logo">
			...
			<a href="{{route('admin.home')}}">
				...
				<img alt="Logo" src="{{asset('assets/media/logos/buzzed_logo.png')}}" style="height: 50px; width: 50px;" />
				...
				<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
					...
					<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
						...
						<ul class="kt-menu__nav ">
							...
							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{route('admin.permissions.index')}}" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-lock"></i><span class="kt-menu__link-text">Permissions</span></a></li>
