			...
			<div class="kt-portlet__head kt-portlet__head--lg">
				...
				<div class="kt-portlet__head-toolbar">
					...
					<div class="kt-portlet__head-wrapper">
						...
						<form action="<?php echo e(route('admin.category.import')); ?>" id="category_import_form" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>	
...
<script>
	...
	$(document).ready(function() {
		...
		$('#category_input_file').change(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('admin.category.import')); ?>",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\rohit\service_provider\service_provider\resources\views/adminseller/category/index.blade.php ENDPATH**/ ?>