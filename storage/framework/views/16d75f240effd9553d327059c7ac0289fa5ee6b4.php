				...
				<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
					...
					<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
						...
						<ul class="kt-menu__nav ">
							...
							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="<?php echo e(route('provider.vendors.index','all')); ?>" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-users"></i><span class="kt-menu__link-text">Customer</span></a></li>

							
							<li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="<?php echo e(route('provider.bookings.index')); ?>" class="kt-menu__link"><i class="kt-menu__link-icon fa fa-receipt"></i><span class="kt-menu__link-text">Bookings</span></a></li>

							<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="<?php echo e(route('provider.review.index')); ?>" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-star"></i><span class="kt-menu__link-text">Review</span></a></li>
...
<?php /**PATH C:\xampp\htdocs\service_provider\resources\views/provider/layout/header.blade.php ENDPATH**/ ?>