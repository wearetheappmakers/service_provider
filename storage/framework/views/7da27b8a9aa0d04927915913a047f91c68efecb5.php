				...
				<div class="kt-portlet__head-toolbar">
					...
					<div class="kt-portlet__head-wrapper">
						...
						<div class="kt-portlet__head-actions">
							...
							<a href="<?php echo e(route('provider.'.$resourcePath.'.create')); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script>
	...
	$(document).ready(function() {
		...
		$('#datatable_rows').DataTable({
			...
			ajax: "<?php echo e(route('provider.vendors.index',$type)); ?>",
        ...
        function Changeuser(ids,field,params) {
            ...
            $.ajax({
                url: "<?php echo e(route('provider.vendors.change_status')); ?>",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('provider.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\service_provider\resources\views/provider/providerseller/vendors/index.blade.php ENDPATH**/ ?>