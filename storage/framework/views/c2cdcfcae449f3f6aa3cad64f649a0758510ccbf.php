        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <?php
                        if(isset($data['type'])){
                            $index= route('provider.'.$resourcePath.'.index',array('type'=>$data['type']));
                        }else {
                            $index= route('provider.'.$resourcePath.'.index');
                        }
                        // echo $index;
                        // exit;
                        ?>
...
<?php echo $__env->make('provider.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\service_provider\resources\views/provider/general/edit_form.blade.php ENDPATH**/ ?>